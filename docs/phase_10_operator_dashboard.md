...
- Shows a Mission Replay panel with play/pause, previous/next, jump, speed presets, scrubber, URL-addressable frame restore, and cross-reference links.
- Exports the selected mission report as a JSON-only ORIMUS Evidence Package or deterministic ZIP evidence bundle.
