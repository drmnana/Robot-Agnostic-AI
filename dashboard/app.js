...
elements.reportExportPdf.addEventListener("click", () => exportSelectedReportPdf());
...
function exportSelectedReportPdf() {
  ...
  window.location.href = `/reports/${encodeURIComponent(state.selectedReportId)}/export-pdf`;
}
